...
FROM '‪‪D:\GitHub Projects\SQL\Book Store\Books.csv' 
CSV HEADER;

-- Import Data into Customers Table
COPY Customers(Customer_ID, Name, Email, Phone, City, Country) 
FROM '‪D:\GitHub Projects\SQL\Book Store\Customers.csv' 
CSV HEADER;

-- Import Data into Orders Table
COPY Orders(Order_ID, Customer_ID, Book_ID, Order_Date, Quantity, Total_Amount) 
FROM '‪D:\GitHub Projects\SQL\Book Store\Orders.csv' 
CSV HEADER;
...
select avg(price)::numeric(10,2) as Average from books
where genre='Fantasy';

-- 3) List customers who have placed at least 2 orders:
select c.name, sum(o.quantity) as Orders_placed
from customers c
join orders o
on c.customer_id=o.customer_id
group by c.name
